...
<%@ include file="/views/layout/common/toast.jsp" %>
    ...
    <main class="flex-grow max-w-[1280px] w-full mx-auto px-5 md:px-16 py-12 md:py-16 min-h-[716px] text-on-surface">

        <div class="mb-10 md:mb-12">
            <h1 class="font-display-lg-mobile md:font-display-lg text-[36px] md:text-[48px] font-bold text-primary mb-2">Your Cart</h1>
        ...
        <c:choose>
            <c:when test="${empty cartItems}">
                <div
                    ...
                    <p class="text-2xl text-[#424752]">Your cart is empty</p>
