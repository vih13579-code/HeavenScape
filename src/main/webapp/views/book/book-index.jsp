                    ...
                    <div class="prod-card">
                        ...
                        <div class="p-3 flex flex-col flex-1">
                            <div class="text-[12px] text-gray-400 mb-1 truncate">
                                <c:forEach var="genre" items="${book.genres}" varStatus="genreStatus"><span class="text-primary font-medium">${genre.genreName}</span><c:if test="${!genreStatus.last}">, </c:if></c:forEach>
                            </div>
                ...
                <nav class="flex justify-center items-center gap-1.5 flex-wrap">
                    <c:if test="${page > 1}">
                        <c:url var="previousPageUrl" value="/products">
                            ...
                            <c:forEach var="selectedCategory" items="${selectedCategoryIDs}"><c:param name="genre" value="${selectedCategory}" /></c:forEach>
