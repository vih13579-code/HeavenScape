...
<html lang="en">
    <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Source+Serif+4:opsz,wght@8..60,600..700&amp;family=Hanken+Grotesk:wght@400..700&amp;display=swap" rel="stylesheet">
        <style>
            * { box-sizing: border-box; }
            body { min-height: 100vh; margin: 0; display: grid; place-items: center; padding: 24px; background: #fbf9f8; color: #1b1c1c; font-family: "Hanken Grotesk", sans-serif; }
            ...
            h1 { margin: 14px 0 12px; color: #04162e; font-family: "Source Serif 4", Georgia, serif; font-size: clamp(32px, 6vw, 48px); line-height: 1.08; }
            p { margin: 0 auto 28px; max-width: 510px; color: #44474d; line-height: 1.65; }
            a { display: inline-flex; align-items: center; justify-content: center; min-height: 44px; padding: 10px 20px; border-radius: 6px; background: #04162e; color: #fff; font-weight: 700; text-decoration: none; }
            a:hover { background: #1a2b44; }
