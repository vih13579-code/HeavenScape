        ...
        <main class="flex-grow pt-32 pb-12 px-4 md:px-16 max-w-[1280px] mx-auto w-full">
            <div class="max-w-2xl mx-auto flex flex-col items-center text-center">
                ...
                <p class="text-base text-gray-600 max-w-lg mb-8">
                    ...
                    <span class="font-bold text-[#071e27]">${order.orderCode}</span>. We will contact you soon to confirm your order.
                </p>
                ...
                <div
                    ...
                    <div class="space-y-3 text-sm">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <span class="font-bold text-[#071e27]">Pending Confirmation</span>
                        </div>

                        <div class="flex justify-between items-center pt-3 border-t border-gray-100">
                            <span class="text-base font-bold text-[#071e27]">Total Payment</span>
