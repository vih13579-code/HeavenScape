                                        ...
                                        <div>
                                            ...
                                            <div class="password-input-wrapper">
                                                <input type="password" id="securityPin" name="securityPin" required
                                                    maxlength="6" pattern="[0-9]{6}" class="input-style pr-10"
                                                    placeholder="Enter 6-digit security PIN">
                                                <button type="button" class="visibility-toggle"
                                                    data-target="securityPin">
                                                    <span class="material-symbols-outlined">visibility</span>
                                                </button>
                                            </div>
                                        </div>
            ...
            <%@ include file="/views/layout/homepage/footer.jsp" %>
                ...
                <script>
                    ...
                    document.getElementById('changePasswordForm').addEventListener('submit', async function (e) {
                        ...
                        if (!securityPin) {
                            showToast('Please enter your security PIN', true);
                            return;
                        }
                        if (!/^\d{6}$/.test(securityPin)) {
                            showToast('Security PIN must be exactly 6 digits', true);
                            return;
                        }
                        if (!newPassword) {
