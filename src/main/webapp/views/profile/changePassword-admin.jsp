                            ...
                            <div class="lg:col-span-2">
                                <div class="card-modern p-8 sm:p-10">
                                    <form id="changePasswordForm" class="space-y-6">
                                        <div>
                                            ...
                                            <div class="relative">
                                                <input type="password" id="currentPassword" name="currentPassword"
                                                    required class="input-premium" placeholder="Enter current password">
                                        ...
                                        <div>
                                            <label class="form-label-modern">
                                                Security PIN <span>*</span>
                                            </label>

                                            <div class="relative">
                                                <input type="password" id="securityPin" name="securityPin" required
                                                    maxlength="6" pattern="[0-9]{6}" inputmode="numeric"
                                                    class="input-premium" placeholder="Enter 6-digit security PIN">

                                                <button type="button" onclick="togglePassword('securityPin', this)"
                                                    class="absolute right-4 top-1/2 -translate-y-1/2 text-slate-500 hover:text-slate-700">
                                        ...
                                        <div>
                                            ...
                                            <div class="relative">
                                                <input type="password" id="newPassword" name="newPassword" required
                                                    class="input-premium" placeholder="Example: Pass@1234">
                                        ...
                                        <div class="flex justify-end gap-3">
                                            ...
                                            <a href="${pageContext.request.contextPath}/login"
                                                class="px-6 py-3 border border-slate-300 rounded-full font-semibold hover:bg-slate-50">
                                                Back
                                            </a>
                        ...
                        <script>
                            ...
                            document.getElementById("changePasswordForm")
                                .addEventListener("submit", async function (e) {
                                    ...
                                    formData.append("securityPin", document.getElementById("securityPin").value);
