                            ...
                            <div class="lg:col-span-3 space-y-6">
                                ...
                                <div id="profile" class="profile-card p-8">
                                    ...
                                    <form action="${pageContext.request.contextPath}/profile" method="post"
                                        ...
                                        <div class="grid md:grid-cols-2 gap-6">
                                            <div>
                                                ...
                                                <input type="text" name="fullname" id="fullname"
                                                    value="${customer.fullname}" required class="input-style">
                                            ...
                                            <div>
                                                ...
                                                <div class="flex gap-2">
                                                    ...
                                                    <button type="button" id="openChangeEmailBtn"
                                            ...
                                            <div>
                                                ...
                                                <input type="date" name="dob" id="dob" value="${customer.dob}"
                                                    max="<%= java.time.LocalDate.now()%>" class="input-style">
                                        ...
                                        <c:if test="${not hasPin}">
                                            <form action="${pageContext.request.contextPath}/profile" method="post">
                                                <div class="mt-8 border rounded-2xl p-6">
                                                    <h3 class="text-xl font-bold mb-4">Security PIN</h3>
                                                    <p class="text-sm text-gray-500 mb-4">
                                                        Set a 6-digit PIN to verify identity before changing your
                                                        password.
                                                    </p>

                                                    <div class="grid md:grid-cols-2 gap-4">
                                                        <div>
                                                            <label class="block mb-2 font-medium">Security PIN</label>
                                                            <input type="password" name="securityPin" maxlength="6"
                                                                pattern="[0-9]{6}" class="input-style"
                                                                placeholder="6 digits">
                                                        </div>
                                                        <div>
                                                            <label class="block mb-2 font-medium">Confirm PIN</label>
                                                            <input type="password" name="securityPinConfirm"
                                                                maxlength="6" pattern="[0-9]{6}" class="input-style"
                                                                placeholder="Confirm 6 digits">
                                                        </div>
                                                    </div>

                                                    <div class="mt-4">
                                                        <button type="submit" name="action" value="save-pin"
                                                            class="bg-primary text-white px-5 py-3 rounded-xl">
                                                            Save Security PIN
                                                        </button>
                                                    </div>
                                                </div>
                                        ...
                                        <c:if test="${hasPin}">
                                            <form action="${pageContext.request.contextPath}/profile" method="post">
                                                <div class="mt-8 border rounded-2xl p-6">
                                                    <h3 class="text-xl font-bold mb-4">Security PIN</h3>
                                                    <p class="text-sm text-gray-500 mb-4">
                                                        Your PIN is already set. You can change it here.
                                                    </p>

                                                    <div class="grid md:grid-cols-2 gap-4">
                                                        <div>
                                                            <label class="block mb-2 font-medium">New Security
                                                                PIN</label>
                                                            <input type="password" name="securityPin" maxlength="6"
                                                                pattern="[0-9]{6}" class="input-style"
                                                        ...
                                                        <div>
                                                            <label class="block mb-2 font-medium">Confirm New
                                                                PIN</label>
                                                            <input type="password" name="securityPinConfirm"
                                                                maxlength="6" pattern="[0-9]{6}" class="input-style"
                                                    ...
                                                    <div class="mt-4">
                                                        <button type="submit" name="action" value="update-pin"
                                                            class="bg-primary text-white px-5 py-3 rounded-xl">
                                                            Update Security PIN
                                                        </button>
                                                    </div>
                    ...
                    <div id="changeEmailModal"
                        ...
                        <div class="bg-white rounded-2xl p-6 w-full max-w-md mx-4">
                            ...
                            <form action="${pageContext.request.contextPath}/profile/change-email" method="post">
                                ...
                                <input type="email" name="newEmail" required placeholder="email-moi@example.com"
