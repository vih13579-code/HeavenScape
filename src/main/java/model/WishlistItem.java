...
public class WishlistItem {
    ...
    public void setWishlistItemID(int v) {
        this.wishlistItemID = v;
    }
    ...
    public void setWishlistID(int v) {
        this.wishlistID = v;
    }
    ...
    public void setAddedAt(Timestamp v) {
        this.addedAt = v;
    }
    ...
    public void setAuthorsDisplay(String v) {
        this.authorsDisplay = v;
    }
