...
public class CustomerDAO {
    ...
    public boolean updateCustomer(
        ...
        String sql = "UPDATE Customer " + "SET fullname = ?, " + "phone = ?, " + "gender = ?, " + "dob = ? "
                + "WHERE customerID = ?";
    ...
    private static final java.util.Set<String> VALID_CUSTOMER_STATUSES = java.util.Set.of("active", "inactive");
    ...
    public List<Customer> getCustomersPaging(int offset, int pageSize) {
        List<Customer> list = new ArrayList<>();
        String sql = "SELECT * FROM (" + " SELECT *, ROW_NUMBER() OVER(ORDER BY customerID DESC) AS rn "
                + " FROM Customer " + ") t " + "WHERE rn > ? AND rn <= ?";
